...
tiff(filename = "Entire_Genome_labeled_result_schizophrenia_erna_brain_tissues_att4.tiff", height= 10, width = 15, unit = "in", res=300, pointsize=11, compression ='lzw') ###Optional, filename change for output if desired. 
