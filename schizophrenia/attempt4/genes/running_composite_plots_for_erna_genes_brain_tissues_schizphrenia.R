...
tiff(filename = "miami_Entire_Genome_result_schizophrenia_erna_gene_brain_tissues.tiff", height= 10, width = 15, unit = "in", res=300, pointsize=11, compression ='lzw') ###Optional, filename change for output if desired. 
