...
metaxcan_results_files_gene <- list.files(path = "/home/bettimj/gamazon_rotation/eRNA_predixcan_models/attempt4/schizophrenia/twas_all_genes", pattern = "schizophrenia2022_gene_imputations.Brain*")  ####################May want to change here, or move desired files to a new directory
metaxcan_results_files_erna <- list.files(path = "/home/bettimj/gamazon_rotation/eRNA_predixcan_models/attempt4/schizophrenia/twas_all", pattern = "schizophrenia2022_eRNA_imputations.Brain*")
...
tiff(filename = "miami_Entire_Genome_result_schizophrenia_erna_gene_brain_tissues.tiff", height= 10, width = 20, unit = "in", res=300, pointsize=11, compression ='lzw') ###Optional, filename change for output if desired. 
