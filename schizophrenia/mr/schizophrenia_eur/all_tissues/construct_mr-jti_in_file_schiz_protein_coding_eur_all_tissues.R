...
out_dir <- "/home/bettimj/gamazon_rotation/eRNA_predixcan_models/attempt4/mr/all_tissues"
...
write.table(merged_df, file = paste(out_dir, "mrjti_erna_all_tissues_schiz_protein_coding_2022_predixcan.txt", sep = "/"), sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)