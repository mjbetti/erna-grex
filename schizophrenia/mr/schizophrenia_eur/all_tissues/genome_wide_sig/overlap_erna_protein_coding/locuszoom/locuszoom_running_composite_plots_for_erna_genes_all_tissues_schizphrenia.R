...
tiff(filename = "17q21.31_miami_Entire_Genome_result_schizophrenia_erna_gene_all_tissues.tiff", height= 10, width = 18, unit = "in", res=300, pointsize=11, compression ='lzw')
mirror_plot_func(d1=appended_gene_d_erna, new_data=appended_gene_d_gene, chr = 17, zoom_left = 40.9 ,  zoom_right = 44.9, 
gene_tag_p = 3.0, x=df_for_ticks, chr_mid_points = "chr_mid_points", chrs = "chrs", color_tissue = c("bisque3","peachpuff2","lightgreen","firebrick4","red","orangered", "powderblue", "blue4","darkturquoise","dodgerblue","cyan","steelblue", 
 			...
 			"lightgoldenrod","tan2","yellow","tomato","tomato3", "burlywood4","plum", "lawngreen", "chocolate4","paleturquoise4","palevioletred3","seagreen1",
 			"darkgreen","honeydew4", "cornsilk2","wheat2","sandybrown","lightsalmon3","gold","darkslategrey","forestgreen","lightcoral", "deeppink","gray0","darkseagreen3"), 
y_min = -15, y_max = 15, y_ticks = NULL, sig_line1 = 5.911, sig_line1_sug = 5.461, sig_line2 = -6.838, sig_line2_sug = -5.718, sig_line1_color =  c("darkred"), sig_line1_sug_color =  c("blue"), sig_line2_color = c("darkred"), sig_line2_sug_color = c("blue"))
dev.off()
