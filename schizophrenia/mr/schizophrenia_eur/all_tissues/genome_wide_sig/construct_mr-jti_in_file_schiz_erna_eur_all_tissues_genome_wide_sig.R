...
write.table(merged_df, file = paste(out_dir, "mrjti_erna_all_tissues_schiz_eur_2022_predixcan_genome_wide_sig.txt", sep = "/"), sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)